...
// Waveshare 1.85B official hardware uses SDMMC 4-bit.
#define SDCARD_SDMMC_CLK_PIN    GPIO_NUM_15
#define SDCARD_SDMMC_CMD_PIN    GPIO_NUM_14
...
// One-time recovery switch. Keep 0 in normal firmware; set 1 only to format an unreadable card.
#define APPSHELL_SD_FORMAT_ON_MOUNT_FAILED 0
// Must be explicitly enabled together with APPSHELL_SD_FORMAT_ON_MOUNT_FAILED for recovery builds.

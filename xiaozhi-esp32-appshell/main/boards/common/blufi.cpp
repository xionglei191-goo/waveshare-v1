            ...
            xTaskCreate(
                [](void* ctx) {
                    ...
                    if (wifi.IsConnected()) {
                        ...
                        AppShell::GetInstance().ReportWifiProvisioned("blufi");
